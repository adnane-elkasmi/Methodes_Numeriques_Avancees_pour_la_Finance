...
S0=10;
Intervalle_de_confiance(S0)

function [] = Intervalle_de_confiance(S0)

% Définition des constantes %

Nmc=1000;
[prix,V_estime1] = Variance(S0);
a= prix-1.96*sqrt(V_estime1/Nmc);
b= prix+1.96*sqrt(V_estime1/Nmc);
...
function [prix,V_estime1] = Variance(S0)
